    ...
    <div className="flex flex-col justify-center min-h-screen max-w-md mx-auto px-4 py-8">
      ...
      <div className="flex flex-col items-center justify-center mb-6 text-center">
        ...
        <p className="text-sm text-gray-600 font-light">
          Enter your details to register for your wellness account.
        </p>
      </div>
        ...
        <Link href="/auth/telegram" className="block">
          <Button className="w-full flex items-center justify-center gap-2" variant="outline">
            <svg width="20px" height="20px" viewBox="0 0 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg">
              <g>
                <path d="M128,0 C57.307,0 0,57.307 0,128 C0,198.693 57.307,256 128,256 L128,256 C198.693,256 256,198.693 256,128 C256,57.307 198.693,0 128,0 Z" fill="#40B3E0" />
      ...
      <form className="w-full">
        ...
        <button
          ...
          type="submit"
        >
          {authMethod === "phone" ? "Send SMS Code" : "Create Account"}
        </button>
      </form>
