        ...
        {menuOpen && (
          <>
            <motion.div
              ...
              className="fixed inset-0 top-[4rem] z-40 bg-black/20 backdrop-blur-[2px]"
          ...
          {bottomTabs.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={
                  "flex min-w-[56px] flex-1 flex-col items-center gap-1 px-2 py-2.5 text-[11px] font-medium transition-colors " +
